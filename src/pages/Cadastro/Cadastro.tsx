...
<div className="row justify-content-md-center  " >
    <input type="nome" placeholder="nome" className="form-control stilologin"  />
  </div>
  <div className="row justify-content-md-center " >
  ...
  <div className="row justify-content-md-center ">
    <input type="password" placeholder="confirmar senha" className="form-control stilologin " />
  </div>
  <div className="row justify-content-md-center ">
    <input type="text" placeholder="unidade apartamento" className="form-control stilologin " />
  </div>
  <div className="row justify-content-md-center">
    <input type="text" placeholder="link da foto" className="form-control stilologin " />
  </div>
